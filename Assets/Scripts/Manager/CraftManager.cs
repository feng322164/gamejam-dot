...
public class CraftManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        herbsReadyToCombin.Add(mainHerbs.getHerbList[0]);
        herbsReadyToCombin.Add(mainHerbs.getHerbList[0]);
        herbsReadyToCombin.Add(mainHerbs.getHerbList[0]);
        assistHerbToCombin.Add(assistHerbs.getHerbList[0]);
        assistHerbToCombin.Add(assistHerbs.getHerbList[0]);
    }
    ...
    void AddAssistHerbToCombin(int i)
    {
        ...
        images[AHTindex+4].sprite = assistHerbToCombin[i].getHerbSprite;
        AHTindex++; AHTindex %= 2;
    }//添加到合成台缓冲
    ...
    public void CleanCraft()
    {
        ...
        assistHerbToCombin[0] = assistHerbs.getHerbList[0];
        assistHerbToCombin[1] = assistHerbs.getHerbList[0];
        ImageUpDate();
    ...
    public void ImageUpDate()
    {
        ...
        for(int i = 0;i < 2;i++)
        {
            images[i + 4].sprite = assistHerbToCombin[i].getHerbSprite;
        }
    }//点击按钮传入图标
}
